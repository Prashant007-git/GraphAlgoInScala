object Task_1_2 extends App{
  ...
  println("Enter smaller jug size")
  val Jug1 = scala.io.StdIn.readInt()
  println("Enter larger jug size")
  val Jug2 = scala.io.StdIn.readInt()
  print("Enter amount of water to be left in larger jug")
